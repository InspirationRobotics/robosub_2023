...
time.sleep(4)
rc.forwardDist(19.3, 3) # auv moves forward 7 meters at power level 3
time.sleep(2)
#time.sleep(2)
#t=0
#while t<2:
...
rc.lateralUni(2, 5)
deg = rc.return_compass()
rc.setHeading(deg+180) # auv turns 93 degrees
...
#     time.sleep(0.1)
#     rc.movement(throttle=0, forward=0, lateral=2, yaw=0, pitch=0, roll=0)
rc.lateralUni(2, 3) # auv moves laterally for 9.5 seconds at power level 2
time.sleep(2)
