...
while True:
    ...
    Gyro_pitch += -gyro[0]  # Integrate the raw Gyro_x readings
    Gyro_roll += -gyro[1]    # Integrate the raw Gyro_y readings
    Gyro_yaw += gyro[2]    # Integrate the raw Gyro_z readings
    ...
    heading = math.atan2(Mag_x_dampened, Mag_y_dampened) * radTodeg
    print(heading)
